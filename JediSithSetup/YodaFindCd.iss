...
const
	UniqueFile = 'GAMEDATA\EXE\JK.EXE';
...
begin
	...
	begin
		...
		begin
			if MsgBox('Please insert Jedi Knight Disc 1 into any drive and press OK.' + Chr(13) + Chr(13) +'Or press cancel to exit setup.', mbConfirmation, MB_OKCANCEL or MB_DEFBUTTON1) = IDOK then
