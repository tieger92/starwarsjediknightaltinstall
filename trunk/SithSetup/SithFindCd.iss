//***************************************************************
//  Mysteries of the Sith Alternate Installer by Troy Hutchinson
...
const
	UniqueFile = 'GAMEDATA\EXE\JKM.EXE';
...
begin
	...
	begin
		...
		begin
			if MsgBox('Please insert Mysteries of the Sith disc into any drive and press OK.' + Chr(13) + Chr(13) +'Or press cancel to exit setup.', mbConfirmation, MB_OKCANCEL or MB_DEFBUTTON1) = IDOK then
